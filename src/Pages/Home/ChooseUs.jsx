    ...
    <div className="bg-[#f8f9fd] pt-1 pb-10">
      <div className="w-7/12 mx-auto sm:w-11/12">
        ...
        <p className="text-xl sm:text-left text-center mt-3">
          ...
          needs we understand that you have options. At KJS Auto Hail Repair
          we're here to make that decision an easy one by highlighting what sets
          us apart
        </p>
      </div>
      <div className="w-11/12 mx-auto pt-9 flex justify-around gap-x-5 gap-y-14  flex-wrap">
        <ChooseUsCard
          ...
          description="With over 30 years in the industry our team boasts a depth of
        ...
        />
        <ChooseUsCard
          text="In-House Expertise"
          description="Unlike many other shops that outsource various stages of the repair
...
faster turnaround times, and a seamless experience for you"
        ...
        <ChooseUsCard
          ...
          description=" Our facilities are equipped with the latest industry technologies
...
innovation to ensure that your vehicle receives the best possible care."
        ...
        <ChooseUsCard
          ...
          description=" Your satisfaction is our top priority. We treat your vehicle as
...
address your concerns"
        />
        <ChooseUsCard
          text="Flawless Painting"
          description="Our in-house painting expertise ensures that every vehicle leaves our
...
work making sure that your vehicle's finish is impeccable"
      ...
      <div className="">
        <p className="text-center sm:text-left text-xl w-7/12 mx-auto my-12 sm:w-11/12">
          When you choose KJS Auto Hail Repair you're not just choosing a repair
          shop; you're selecting a partner dedicated to delivering the highest
          quality repairs, outstanding customer service, and a commitment to
          excellence. Your vehicle deserves nothing less and neither do you.
          Experience the difference with us and you'll see why our customers
          prefer our services.
        </p>
      </div>
