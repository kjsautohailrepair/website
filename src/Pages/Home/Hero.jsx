...
const Hero = () => {
    ...
    //                 <Link to={"https://calendar.app.google/Kvq2tb5sNKmrq6su9"} className="w-40 h-12 md:mx-auto flex justify-center items-center  mt-5 rounded-lg bg-[#f79f24] font-semibold text-white">Schedule Estimate!</Link>
    //             </div>
